    ...
    public partial class GetACSEvent : Form
    {
        ...
        {/*
            ...
            else
            {
                ...
                {
                    MessageBox.Show("Cihaza bağlanılamadı Hata: Girdiğiniz bilgiler yanlış.");
                ...
                {
                    MessageBox.Show("Cihaza bağlanılamadı Hata: İnternet hatası veya DVR meşgul.");
                }
            }
            */
        }
            ...
            if (m_UserID == -1)
            {
                ...
                foreach (JProperty item in devicesJson.Properties())
                {
                    ...
                    else
                    {
                        ...
                        {
                            MessageBox.Show($"{deviceName} Cihazında Hata: İnternet hatası veya DVR meşgul.");
